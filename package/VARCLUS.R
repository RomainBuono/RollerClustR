VARCLUS <- R6Class("VARCLUS",
  ...
  private = list(
    ...
    # =========================================================================
    # refit_with_k : Non applicable pour VARCLUS (clustering hiérarchique)
    # =========================================================================
  ...
  public = list(
    ...
    initialize = function(stop_eigenvalue = 1.0, 
                          ...
                          cr = FALSE) {
      super$initialize(k = NULL, cr = cr, na_action = "warn")
    ...
    # =========================================================================
    # PREDICT : Non applicable pour clustering de variables
    # =========================================================================
    ...
    cut_tree = function(k) {
      ...
      # Implémentation simplifiée : nécessiterait parcours de l'arbre
